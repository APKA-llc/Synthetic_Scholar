...
COLLEGE_DIRECTORY = "Colleges/CSU"
...
def generate_pdf(text, subject, topic, prompt_index):
    ...
    SimpleDocTemplate(COLLEGE_DIRECTORY + "/" + SUBFOLDER_DIRECTORY + "/" + allias + "_" + subject.upper() + topic.lower() + ".pdf", pagesize=letter, rightMargin=60.5,
                      leftMargin=60.5, topMargin=60.5,
                      bottomMargin=60.5).build(document)
