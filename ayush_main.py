...
def generate_pdf(text, subject, topic, prompt_index):
    ...
    SimpleDocTemplate(COLLEGE_DIRECTORY + "/" + SUBFOLDER_DIRECTORY + "/" + str(counter) + "_" + subject + "_" + topic + ".pdf", pagesize=letter,
                      rightMargin=25,
                      leftMargin=25, topMargin=25,
                      bottomMargin=25).build(document)
