            ...
            for prompt_index in range(0, NUM_OF_PROMPTS):
                ...
                if "CS" in current_subject:
                    prompts = [
                        ...
                        "Imagine you are a student studying for your final exams. Write a long and detailed list of sample computer science exam problems (using coding examples) on " + current_topic + " for the course " + current_subject + " with solutions included. For every coding solution, start with a comment saying 'Start of Code' and end it with a comment saying 'End of Code'.",
                        ...
                        "Imagine you are a student studying for your final exams. Create a sample topic outline that you would find in a syllabus on " + current_topic + " for the course " + current_subject + " and for each subtopic outline the main things to study and really good problem solving strategies to use on the exam."]
                    ...
                    prompts = [
                        "Act as if you are a student studying for your final exams. Write a very detailed study guide on " + current_topic + " for the course " + current_subject + ". Please include relevant equations, key concepts, definitions, and rules when possible. Be descriptive and thorough in your notes.",
                        "Imagine you are a student studying for your final exams. Write a long and detailed list of sample exam problems on " + current_topic + " for the course " + current_subject + " with solutions included.",
                        "In the format of a homework sheet with the title 'Extra Practice Problems', Create a long list of problems on " + current_topic + " for the course " + current_subject + " and for each question first explain how you would go about solving the problem, then solve the problem showing your work. Be sure to solve many problems incorrectly, and next to the solution denote whether it is correct or incorrect by writing '[CORRECT]' or '[INCORRECT]'. If it is incorrect, show the correct answer and explain how to get the correct answer.",
                        "Imagine you are a student studying for your final exams. Create a sample topic outline that you would find in a syllabus on " + current_topic + " for the course " + current_subject + " and for each subtopic outline the main things to study and really good problem solving strategies to use on the exam."]
                else:
                    prompts = [
                        "Act as if you are a student studying for your final exams. Write very detailed lecture notes on " + current_topic + " for the course " + current_subject + ". Please include relevant key concepts, definitions, rules, and examples within the notes. Be descriptive and thorough in your notes.",
                        "Imagine you are a student studying for your final exams. Write a long and detailed list of sample exam problems on " + current_topic + " for the course " + current_subject + " with solutions included.",
                        "In the format of a homework sheet with the title 'Extra Practice Problems', Create a long list of problems on " + current_topic + " for the course " + current_subject + " and for each question first explain how you would go about solving the problem, then solve the problem showing your work. Be sure to solve many problems incorrectly, and next to the solution denote whether it is correct or incorrect by writing '[CORRECT]' or '[INCORRECT]'. If it is incorrect, show the correct answer and explain how to get the correct answer.",
                        "Imagine you are a student studying for your final exams. Create a sample topic outline that you would find in a syllabus on " + current_topic + " for the course " + current_subject + " and for each subtopic outline the main things to study and really good problem solving strategies to use on the exam."]
