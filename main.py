...
API_KEY = "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"
    ...
    for line in subjects.readlines():
        ...
        for index, topic in enumerate(list_of_topics):
            ...
            if "CS" in current_subject:
                prompt = "Act as if you are a student studying for your final exams. Write very detailed lecture notes on " + current_topic + " for the course " + current_subject + ". Please include coding examples, key concepts, and definitions within the notes. Be descriptive and thorough in your notes. Additionally, at the very end of the notes include a disclaimer that says 'This text was auto-generated by AI'. This disclaimer should be centered."
                ...
                prompt = "Act as if you are a student studying for your final exams. Write a very detailed study guide on " + current_topic + " for the course " + current_subject + ". Please include relevant equations, key concepts, definitions, and rules when possible. Be descriptive and thorough in your notes. Additionally, at the very end of the notes include a disclaimer that says 'This text was auto-generated by AI'. This disclaimer should be centered."
            else:
                prompt = "Act as if you are a student studying for your final exams. Write very detailed lecture notes on " + current_topic + " for the course " + current_subject + ". Please include relevant key concepts, definitions, rules, and examples within the notes. Be descriptive and thorough in your notes. Additionally, at the very end of the notes include a disclaimer that says 'This text was auto-generated by AI'. This disclaimer should be centered."
...
def generate_pdf(text, subject, topic):
    ...
    for line in text.splitlines():
        ...
        if line == "This text was auto-generated by AI.":
